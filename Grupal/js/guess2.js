...
async function showPokemonGuessModal(correctPokemonName) {
    ...
    exitButton.addEventListener('click', () => {
      ...
      // Si quieres hacer algo específico al cerrar la modal, agrégalo aquí
    });
    ...
    // En la función showPokemonGuessModal
  ...
  function checkAnswer(selectedOption, correctPokemonName) {
    if (selectedOption === correctPokemonName) {
      ...
      // Ocultar la ventana modal en caso de respuesta incorrecta
      modal.style.display = 'none';
    }
  
    // Actualizar la puntuación del usuario en el DOM
    userScore.textContent = `Puntuación: ${score}`;
  
    // Mostrar la siguiente imagen de Pokémon
    showPokemon();
  }
